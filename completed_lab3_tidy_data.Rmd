...
```{r}
scfa_wkly_qc <- read_excel("raw_data/SCFA_data.xlsx", sheet = "SCFA_wkly", col_names = TRUE, trim_ws = TRUE, na = c("", "NA", "-----")) %>% 
  rename_all(tolower) %>%
  rename(acetate_mM_per_kg_median = acetate_median, 
         acetate_mM_per_kg_mean = acetate_mean,
         butyrate_mM_per_kg_median = butyrate_median, 
         butyrate_mM_per_kg_mean = butyrate_mean,
         propionate_mM_per_kg_median = propionate_median, 
         propionate_mM_per_kg_mean = propionate_mean,) %>%
  filter(study_week == "week1" | study_week == "week3") %>%
  ...
  mutate(median_total_scfa = (acetate_mM_per_kg_median + butyrate_mM_per_kg_median + propionate_mM_per_kg_median))
```
