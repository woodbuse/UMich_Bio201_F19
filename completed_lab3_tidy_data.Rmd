...
scfa_indv_qc <- scfa_indv %>%
  ...
  mutate(acetate_mM_per_kg = acetate_mM / sample_wt_kg) %>%
  mutate(butyrate_mM_per_kg = butyrate_mM / sample_wt_kg) %>%
  mutate(propionate_mM_per_kg = propionate_mM / sample_wt_kg) %>%
